...
template<typename text, typename object, typename integer>
typename map_naive<text, object, integer>::traversal_searcher
...
template<typename text, typename object, typename integer>
struct map_naive<text, object, integer>::traversal_searcher
{
	...
	traversal_searcher(const map_naive<text, object, integer>& index): index(index){}

...
template<typename text, typename object, typename integer>
typename map_tail<text, object, integer>::traversal_searcher
...
template<typename text, typename object, typename integer>
struct map_tail<text, object, integer>::traversal_searcher
{
	...
	traversal_searcher(const map_tail<text, object, integer>& index): index(index){}
